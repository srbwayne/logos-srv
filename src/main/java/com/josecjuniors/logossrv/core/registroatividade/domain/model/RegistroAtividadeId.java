...
public class RegistroAtividadeId extends DomainObjectId {
    public RegistroAtividadeId() { super(); }
    public RegistroAtividadeId(UUID value) { super(value); }
    public static RegistroAtividadeId generate() { return new RegistroAtividadeId(UUID.randomUUID()); }
}
